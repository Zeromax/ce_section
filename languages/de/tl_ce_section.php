...
$GLOBALS['TL_LANG']['tl_ce_section']['core'] = "Core Layout Bereiche";
$GLOBALS['TL_LANG']['tl_ce_section']['custom'] = "Eigene Layout Bereiche";
$GLOBALS['TL_LANG']['tl_ce_section']['edit'][0] = "Editiere Layoutbereich";
$GLOBALS['TL_LANG']['tl_ce_section']['edit'][1] = "Editiere Layoutbereich ID %s";
$GLOBALS['TL_LANG']['tl_ce_section']['copy'][0] = "Dupliziere Layoutbereich";
$GLOBALS['TL_LANG']['tl_ce_section']['copy'][1] = "Dupliziere Layoutbereich ID %s";
$GLOBALS['TL_LANG']['tl_ce_section']['delete'][0] = "Lösche Layoutbereich";
$GLOBALS['TL_LANG']['tl_ce_section']['delete'][1] = "Lösche Layoutbereich ID %s";
$GLOBALS['TL_LANG']['tl_ce_section']['toggle'][0] = "Ignoriere Layoutbereich";
$GLOBALS['TL_LANG']['tl_ce_section']['toggle'][1] = "Ignoriere Layoutbereich ID %s";
$GLOBALS['TL_LANG']['tl_ce_section']['pasteafter'][0] = "Danach einfügen";
$GLOBALS['TL_LANG']['tl_ce_section']['pasteafter'][1] = "Nach Layoutbereich ID %s einfügen";
$GLOBALS['TL_LANG']['tl_ce_section']['show'][0] = "Layoutbereich Details";
